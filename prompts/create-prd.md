...
1.  **Receive Initial Prompt:** The user provides a brief description or request for a new feature or functionality along with supplemental context.
...
4.  **Non-Goals (Out of Scope):** Clearly state what this feature will *not* include to manage scope.
5.  **Design Considerations (Optional):** Link to resources, describe system behavior, or mention relevant components/styles if applicable.
6.  **Technical Considerations (Optional):** Mention any known technical constraints, dependencies, or suggestions
